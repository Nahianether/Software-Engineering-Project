 ...
 //sql query to fetch information of registerd user and finds user match.
  $query="Select * from candidate where C_Location LIKE '%$loca%'";
	...
	?>
	 ...
	 <br><br><br>
     <form action="showCandidateInfoA2-1.php" method="post">
	 <?php
	...
	?>
	<a href="showCandidateInfoA2-1.php"><br><input type="submit" value="Submit" name="submit" style="position:absolute;left:25%;font-size:20px"></a>
	</form>
	</div>
	<?php
