...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div style="position: absolute;top:40%;left: 60%;font-size: 30px">
     Voting Line Did not Open Yet


    </div>
<button type="button" name="button" style="position:absolute;height:6%;width:13.1%;top:62%;left:63%;"><a href="volunteerLogout.php">Logout  /  প্রস্থান</button>
