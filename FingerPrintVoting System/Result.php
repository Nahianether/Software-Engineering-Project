...
$conn = mysqli_connect("localhost", "root", "");
 ...
 $query="Select * from result where R_Location like '%$add%'";
 $result=mysqli_query($conn,$query);
  ...
  if($row['Published']==0){
     $query = "SELECT * from result,candidate where result.C_NID=candidate.C_NID and R_Location Like '$add' ORDER by R_Count DESC";
...
<?php
  ...
  $query="Select * from Winner Where Location like '%$add%'";
...
<button type="button" style="position:absolute;top:80%;left:72%;font-size:20px "><a href='voterHome.php'>Back to Home</a></button> 
