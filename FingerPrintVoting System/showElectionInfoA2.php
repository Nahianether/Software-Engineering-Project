...
$conn = mysqli_connect("localhost", "root", "");
 ...
 $db = mysqli_select_db($conn, "fingerprint");
  $query = "SELECT * FROM election WHERE  Area_Info  Like '%$loca%' and VotingLine=0 and  E_Date>=now()" ;
 ...
 <button type="button" style="position:absolute;left:30%;font-size:80% "><a href='adminHome2.php'>Back To Home  /  প্রথম পৃষ্ঠায় ফিরে যান</a></button> 
