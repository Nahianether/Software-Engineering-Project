...
// $row = mysqli_fetch_assoc($result);
	...
	<?php
	                        ...
	                        while($row=mysqli_fetch_assoc($result)){  
							 ...
							 <form action="voterReview1.php" method="post">  
							  ...
							  <a href="voterReview1.php"><br><input type="submit" style="position:absolute;top:200%;left:80%;font-size:80% " value="Give Review" name="submit"></a>
							   </form>
