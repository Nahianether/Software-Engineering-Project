...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div >
      <button type="button" name="button" style="position:absolute;height:6%;width:13.1%;top:32%;left:63%;"><a href="adminHomeEdit.php">Open Voting Line  /   ভোটিং লাইন খুলুন</a></button>
      ...
      <button type="button" name="button" style="position:absolute;height:6%;width:13.1%;top:52%;left:63%;"><a href="showCandidateInfoA.php">Show Candidate Info  /  প্রার্থী তথ্য দেখান</button>
