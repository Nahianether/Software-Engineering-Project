...
$conn = mysqli_connect("localhost", "root", "");
 ...
 $db = mysqli_select_db($conn, "fingerprint");
  $query = "SELECT * FROM election WHERE E_Date>=now() and VotingLine=0 and Area_Info Like '%$location%'";
 ...
 <label type="election" style="position:absolute;top:30%;left:46%;font-size:20px">
 ...
 <button type="button" name="button"  style="position:absolute;width:15%;left:40%;"><a href="candidateHome.php">Back To Home  /  প্রথম পৃষ্ঠায় ফিরে যান</a></button>
